...
const connectWeb3 = async () => {
    try {
        ...
        const amusedFaucet = new web3.eth.Contract(amusedFaucetABI, process.env.amusedFaucetAddress);

        const { address: admin } = web3.eth.accounts.wallet.add(process.env.adminKey);
